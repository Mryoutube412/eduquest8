...
export const SUBJECTS: SubjectInfo[] = [
  {
    ...
    topics: [
      { id: 'es_zit_anlam', name: 'Eş-Zıt Anlam', icon: '🔄', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+türkçe+eş+zıt+anlam+konu+anlatımı+tonguç' },
      { id: 'sozcuk_turleri', name: 'Sözcük Türleri', icon: '📝', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+sözcük+türleri+konu+anlatımı+tonguç' },
      { id: 'deyimler', name: 'Deyimler', icon: '💬', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+deyimler+konu+anlatımı' },
      { id: 'atasozleri', name: 'Atasözleri', icon: '📜', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+atasözleri+konu+anlatımı' },
      { id: 'tamlama', name: 'Tamlamalar', icon: '🔗', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+tamlamalar+konu+anlatımı+tonguç' },
      { id: 'fiiller', name: 'Fiiller', icon: '🏃', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+fiiller+konu+anlatımı+tonguç' },
      { id: 'ses_bilgisi', name: 'Ses Bilgisi', icon: '🔊', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+ses+bilgisi+konu+anlatımı+tonguç' },
      { id: 'yazim_kurallari', name: 'Yazım Kuralları', icon: '✍️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+yazım+kuralları+konu+anlatımı' },
      { id: 'fiilimsiler', name: 'Fiilimsiler', icon: '🏃‍♂️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+fiilimsiler+konu+anlatımı+tonguç' },
      { id: 'cumlenin_ogeleri', name: 'Cümlenin Öğeleri', icon: '🧩', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+cümlenin+öğeleri+konu+anlatımı+tonguç' },
      { id: 'cumle_turleri', name: 'Cümle Türleri', icon: '📜', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+cümle+türleri+konu+anlatımı' },
      { id: 'metin_turleri', name: 'Metin Türleri', icon: '📚', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+metin+türleri+konu+anlatımı' },
      { id: 'paragraf', name: 'Paragraf', icon: '📝', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+paragraf+konu+anlatımı+tonguç' },
      { id: 'noktalama_isaretleri', name: 'Noktalama İşaretleri', icon: '❗', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+noktalama+işaretleri+konu+anlatımı' },
      { id: 'gercek_mecaz', name: 'Gerçek-Mecaz Anlam', icon: '🌟', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+gerçek+mecaz+anlam+konu+anlatımı' },
      { id: 'oznel_nesnel', name: 'Öznel-Nesnel Anlatım', icon: '🧠', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+öznel+nesnel+anlatım+konu+anlatımı' },
      { id: 'soz_sanatlari', name: 'Söz Sanatları', icon: '🎨', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+söz+sanatları+konu+anlatımı+tonguç' },
    ],
  },
  {
    id: 'matematik',
    ...
    topics: [
      { id: 'toplama_cikarma', name: 'Toplama-Çıkarma', icon: '➕', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+tam+sayılarla+toplama+çıkarma+konu+anlatımı' },
      { id: 'carpma_bolme', name: 'Çarpma-Bölme', icon: '✖️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+çarpma+bölme+konu+anlatımı' },
      { id: 'kesirler', name: 'Kesirler', icon: '🥧', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+kesirler+konu+anlatımı+tonguç' },
      { id: 'geometri', name: 'Geometri', icon: '📐', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+geometri+konu+anlatımı+tonguç' },
      { id: 'uslu_sayilar', name: 'Üslü Sayılar', icon: '🔢', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+üslü+sayılar+konu+anlatımı+tonguç' },
      { id: 'denklemler', name: 'Denklemler', icon: '⚖️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+denklemler+konu+anlatımı+tonguç' },
      { id: 'oran_oranti', name: 'Oran-Orantı', icon: '📊', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+oran+orantı+konu+anlatımı+tonguç' },
      { id: 'olasilik', name: 'Olasılık', icon: '🎲', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+olasılık+konu+anlatımı+tonguç' },
      { id: 'ebob_ekok', name: 'EBOB-EKOK', icon: '🔍', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+ebob+ekok+konu+anlatımı+tonguç' },
      { id: 'karekok', name: 'Kareköklü İfadeler', icon: '√', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+kareköklü+ifadeler+konu+anlatımı+tonguç' },
      { id: 'veri_analizi', name: 'Veri Analizi', icon: '📊', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+veri+analizi+konu+anlatımı' },
      { id: 'cebirsel_ifadeler', name: 'Cebirsel İfadeler', icon: 'x²', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+cebirsel+ifadeler+konu+anlatımı+tonguç' },
      { id: 'koordinat', name: 'Koordinat Sistemi', icon: '🗺️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+koordinat+sistemi+konu+anlatımı' },
      { id: 'esitsizlik', name: 'Eşitsizlikler', icon: '< >', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+eşitsizlikler+konu+anlatımı' },
      { id: 'ucgenler', name: 'Üçgenler & Pisagor', icon: '△', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+üçgenler+pisagor+konu+anlatımı+tonguç' },
      { id: 'oteleme_yansima', name: 'Öteleme & Yansıma', icon: '↔️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+öteleme+yansıma+konu+anlatımı' },
      { id: 'prizmalar', name: 'Prizmalar & Geometrik Cisimler', icon: '⬛', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+prizmalar+geometrik+cisimler+konu+anlatımı+tonguç' },
    ],
  },
  {
    id: 'fen',
    ...
    topics: [
      { id: 'madde', name: 'Madde ve Özellikleri', icon: '🧪', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+madde+ve+özellikleri+konu+anlatımı+tonguç' },
      { id: 'canlilar', name: 'Canlılar Dünyası', icon: '🌿', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+canlılar+dünyası+konu+anlatımı+tonguç' },
      { id: 'kuvvet', name: 'Kuvvet ve Hareket', icon: '🏋️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+kuvvet+ve+hareket+konu+anlatımı+tonguç' },
      { id: 'elektrik', name: 'Elektrik', icon: '⚡', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+elektrik+konu+anlatımı+tonguç' },
      { id: 'isik_ses', name: 'Işık ve Ses', icon: '💡', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+ışık+ve+ses+konu+anlatımı+tonguç' },
      { id: 'dunya_uzay', name: 'Dünya ve Uzay', icon: '🌍', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+dünya+ve+uzay+konu+anlatımı' },
      { id: 'ekosistem', name: 'Ekosistem', icon: '🌳', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+ekosistem+konu+anlatımı+tonguç' },
      { id: 'mevsimler_ve_iklim', name: 'Mevsimler ve İklim', icon: '☀️❄️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+mevsimler+iklim+konu+anlatımı' },
      { id: 'dna_genetik_kod', name: 'DNA ve Genetik Kod', icon: '🧬', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+dna+genetik+kod+konu+anlatımı+tonguç' },
      { id: 'basinc', name: 'Basınç', icon: '📏', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+basınç+konu+anlatımı+tonguç' },
      { id: 'basit_makineler', name: 'Basit Makineler', icon: '⚙️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+basit+makineler+konu+anlatımı+tonguç' },
    ],
  },
  {
    id: 'tarih', name: 'T.C. İnkılap Tarihi', icon: '🏛️', gradient: 'gradient-tarih',
    topics: [
      { id: 'kurtulus_savasi', name: 'Kurtuluş Savaşı', icon: '⚔️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+kurtuluş+savaşı+konu+anlatımı+tonguç' },
      { id: 'cumhuriyet', name: 'Cumhuriyetin İlanı', icon: '🇹🇷', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+cumhuriyetin+ilanı+konu+anlatımı+tonguç' },
      { id: 'ataturk_ilkeleri', name: 'Atatürk İlkeleri', icon: '📋', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+atatürk+ilkeleri+konu+anlatımı+tonguç' },
      { id: 'inkilaplar', name: 'İnkılaplar', icon: '🔄', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+inkılaplar+konu+anlatımı+tonguç' },
      { id: 'tbmm', name: 'TBMM', icon: '🏛️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+tbmm+açılması+konu+anlatımı+tonguç' },
      { id: 'antlasmalar', name: 'Antlaşmalar', icon: '📜', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+antlaşmalar+konu+anlatımı+tonguç' },
      { id: 'milli_mucadele', name: 'Milli Mücadele', icon: '🎖️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+milli+mücadele+konu+anlatımı+tonguç' },
    ],
  },
  {
    id: 'ingilizce', name: 'İngilizce', icon: '🌍', gradient: 'gradient-ingilizce',
    topics: [
      { id: 'greetings', name: 'Greetings', icon: '👋', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+ingilizce+greetings+konu+anlatımı' },
      { id: 'present_tense', name: 'Present Tense', icon: '⏰', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+present+tense+konu+anlatımı' },
      { id: 'past_tense', name: 'Past Tense', icon: '⏪', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+past+tense+konu+anlatımı' },
      { id: 'vocabulary', name: 'Vocabulary', icon: '📚', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+ingilizce+vocabulary+konu+anlatımı' },
      { id: 'prepositions', name: 'Prepositions', icon: '📍', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+prepositions+konu+anlatımı' },
      { id: 'comparatives', name: 'Comparatives', icon: '⚖️', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+comparatives+superlatives+konu+anlatımı' },
      { id: 'reading', name: 'Reading', icon: '📖', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+ingilizce+reading+konu+anlatımı' },
      { id: 'modals', name: 'Modal Verbs', icon: '🔑', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+modal+verbs+konu+anlatımı' },
    ],
  },
  {
    id: 'din', name: 'Din Kültürü', icon: '☪️', gradient: 'gradient-din',
    topics: [
      { id: 'ibadet', name: 'İbadet', icon: '🕌', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+din+kültürü+ibadet+konu+anlatımı' },
      { id: 'kuran', name: "Kur'an-ı Kerim", icon: '📖', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+kuran+kerim+konu+anlatımı' },
      { id: 'peygamberler', name: 'Peygamberler', icon: '⭐', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+peygamberler+konu+anlatımı' },
      { id: 'ahlak', name: 'Ahlak', icon: '💎', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+din+kültürü+ahlak+konu+anlatımı' },
      { id: 'islam_tarihi', name: 'İslam Tarihi', icon: '📅', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+islam+tarihi+konu+anlatımı' },
      { id: 'inanc', name: 'İnanç', icon: '🤲', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+din+kültürü+inanç+konu+anlatımı' },
      { id: 'hadis', name: 'Hadis', icon: '📜', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+hadis+konu+anlatımı' },
      { id: 'degerler', name: 'Değerler Eğitimi', icon: '🌟', videoUrl: 'https://www.google.com/search?tbm=vid&q=8+sınıf+değerler+eğitimi+konu+anlatımı' },
    ],
  },
];
...
// ==========================================
  ...
  { id: 'f131', subject: 'fen', topic: 'mevsimler', difficulty: 'zor', question: 'Güneş ışınları dik geldiğinde birim yüzeye düşen enerji miktarı nasıl olur?', options: ['Azalır', 'Artar', 'Değişmez', 'Sıfır olur'], correctIndex: 1, explanation: 'Dik açı enerjiyi yoğunlaştırır, sıcaklık artar.', tags: ['enerji'] },
...
{ id: 'e126', subject: 'ingilizce', topic: 'reading', difficulty: 'orta', question: 'Text: "Jack is a couch potato." What does Jack do?', options: ['Plays sports', 'Watches TV a lot', 'Cooks', 'Reads'], correctIndex: 1, explanation: 'Couch potato: Tembel/TV izleyen.', tags: ['reading'] },
{ id: 'e127', subject: 'ingilizce', topic: 'reading', difficulty: 'orta', question: 'Text: "To make tea, boil water first." What is the first step?', options: ['add sugar', 'boil water', 'drink tea', 'wash cup'], correctIndex: 1, explanation: 'Sequence markers.', tags: ['reading'] },
{ id: 'e128', subject: 'ingilizce', topic: 'reading', difficulty: 'orta', question: 'Text: "She is into jazz." What does she think about jazz?', options: ['She hates it', 'She likes it', 'She is bored', 'She is scared'], correctIndex: 1, explanation: 'To be into: Sevmek.', tags: ['reading'] },
{ id: 'e129', subject: 'ingilizce', topic: 'reading', difficulty: 'orta', question: 'Text: "I can\'t stand heavy metal." Does he like it?', options: ['Yes', 'A little', 'No, he hates it', 'Sometimes'], correctIndex: 2, explanation: 'Can\'t stand: Dayanamamak/Nefret etmek.', tags: ['reading'] },
{ id: 'e130', subject: 'ingilizce', topic: 'reading', difficulty: 'orta', question: 'Text: "The internet has pros and cons." Is the internet only good?', options: ['Yes', 'No, it has bad sides too', 'Only bad', 'Free'], correctIndex: 1, explanation: 'Pros/Cons: Artı ve eksiler.', tags: ['reading'] },
{ id: 'e131', subject: 'ingilizce', topic: 'reading', difficulty: 'zor', question: 'Text: "Traditional dishes are more popular in villages." Where are they popular?', options: ['Cities', 'Villages', 'Space', 'Schools'], correctIndex: 1, explanation: 'Locating information.', tags: ['reading'] },
{ id: 'e132', subject: 'ingilizce', topic: 'reading', difficulty: 'zor', question: 'Text: "Bungee jumping is more challenging than trekking." Which is harder?', options: ['Trekking', 'Bungee jumping', 'Both', 'None'], correctIndex: 1, explanation: 'Challenging: Zorlayici.', tags: ['reading'] },
{ id: 'e133', subject: 'ingilizce', topic: 'reading', difficulty: 'zor', question: 'Text: "She prefers rafting to diving." What is her favorite?', options: ['Diving', 'Rafting', 'Both', 'Swimming'], correctIndex: 1, explanation: 'Prefer X to Y.', tags: ['reading'] },
{ id: 'e134', subject: 'ingilizce', topic: 'reading', difficulty: 'zor', question: 'Text: "The earthquake caused massive damage." Was it a small event?', options: ['Yes', 'No, it was huge', 'Maybe', 'Unknown'], correctIndex: 1, explanation: 'Massive: Devasa.', tags: ['reading'] },
{ id: 'e135', subject: 'ingilizce', topic: 'reading', difficulty: 'zor', question: 'Text: "Success depends on hard work." What is the key to success?', options: ['Luck', 'Hard work', 'Money', 'Friends'], correctIndex: 1, explanation: 'Conditional information.', tags: ['reading'] },

// --- 8. MODAL VERBS (15 SORU TAMAMI) ---
{ id: 'e136', subject: 'ingilizce', topic: 'modals', difficulty: 'kolay', question: 'I ____ swim when I was five.', options: ['can', 'could', 'must', 'should'], correctIndex: 1, explanation: 'Could: Past ability.', tags: ['grammar'] },
{ id: 'e137', subject: 'ingilizce', topic: 'modals', difficulty: 'kolay', question: 'You ____ listen to your teacher.', options: ['should', 'can\'t', 'mustn\'t', 'shall'], correctIndex: 0, explanation: 'Should: Advice.', tags: ['grammar'] },
{ id: 'e138', subject: 'ingilizce', topic: 'modals', difficulty: 'kolay', question: '____ I come in?', options: ['Must', 'May', 'Should', 'Will'], correctIndex: 1, explanation: 'May: Permission.', tags: ['grammar'] },
{ id: 'e139', subject: 'ingilizce', topic: 'modals', difficulty: 'kolay', question: 'I ____ speak English well.', options: ['can', 'must', 'should', 'may'], correctIndex: 0, explanation: 'Can: Ability.', tags: ['grammar'] },
{ id: 'e140', subject: 'ingilizce', topic: 'modals', difficulty: 'kolay', question: 'You ____ wash your hands.', options: ['can', 'should', 'might', 'shall'], correctIndex: 1, explanation: 'Should: Recommendation.', tags: ['grammar'] },
{ id: 'e141', subject: 'ingilizce', topic: 'modals', difficulty: 'orta', question: 'You ____ smoke here. It is forbidden!', options: ['should', 'mustn\'t', 'can', 'may'], correctIndex: 1, explanation: 'Mustn\'t: Prohibition.', tags: ['grammar'] },
{ id: 'e142', subject: 'ingilizce', topic: 'modals', difficulty: 'orta', question: 'It ____ rain today. Look at the clouds.', options: ['must', 'might', 'should', 'shall'], correctIndex: 1, explanation: 'Might: Possibility.', tags: ['grammar'] },
{ id: 'e143', subject: 'ingilizce', topic: 'modals', difficulty: 'orta', question: '____ you help me, please?', options: ['Must', 'Could', 'Should', 'Shall'], correctIndex: 1, explanation: 'Could: Polite request.', tags: ['grammar'] },
{ id: 'e144', subject: 'ingilizce', topic: 'modals', difficulty: 'orta', question: 'We ____ wear a uniform at school.', options: ['can', 'have to', 'might', 'may'], correctIndex: 1, explanation: 'Have to: Obligation.', tags: ['grammar'] },
{ id: 'e145', subject: 'ingilizce', topic: 'modals', difficulty: 'orta', question: 'You ____ do your homework.', options: ['must', 'can', 'may', 'could'], correctIndex: 0, explanation: 'Must: Strong obligation.', tags: ['grammar'] },
{ id: 'e146', subject: 'ingilizce', topic: 'modals', difficulty: 'zor', question: 'If you want to lose weight, you ____ eat less sugar.', options: ['must', 'should', 'can', 'may'], correctIndex: 1, explanation: 'Should: Advice.', tags: ['grammar'] },
{ id: 'e147', subject: 'ingilizce', topic: 'modals', difficulty: 'zor', question: 'She ____ be at home. Her car is outside.', options: ['must', 'can\'t', 'should', 'shall'], correctIndex: 0, explanation: 'Must: Deduction (high certainty).', tags: ['grammar'] },
{ id: 'e148', subject: 'ingilizce', topic: 'modals', difficulty: 'zor', question: 'I ____ rather stay home than go out.', options: ['will', 'would', 'should', 'must'], correctIndex: 1, explanation: 'Would rather: Preference.', tags: ['grammar'] },
{ id: 'e149', subject: 'ingilizce', topic: 'modals', difficulty: 'zor', question: 'You ____ better see a doctor.', options: ['should', 'had', 'must', 'would'], correctIndex: 1, explanation: 'Had better: Strong advice.', tags: ['grammar'] },
{ id: 'e150', subject: 'ingilizce', topic: 'modals', difficulty: 'zor', question: '____ we dance?', options: ['Shall', 'Must', 'Will', 'Would'], correctIndex: 0, explanation: 'Shall: Suggestion.', tags: ['grammar'] },
  ...
  // ═══════════════ EK SORULAR - TÜM DERSLER ═══════════════

  // İNGİLİZCE: Greetings ek
  { id: 'en_gr_k1', subject: 'ingilizce', topic: 'greetings', difficulty: 'kolay', question: 'How do you say "Günaydın" in English?', options: ['Good morning', 'Good night', 'Good evening', 'Good afternoon'], correctIndex: 0, explanation: 'Good morning = Günaydın', tags: ['greeting'] },
  { id: 'en_gr_k2', subject: 'ingilizce', topic: 'greetings', difficulty: 'kolay', question: '"Nice to meet you" means:', options: ['Görüşürüz', 'Tanıştığıma memnun oldum', 'Hoşça kal', 'Nasılsın'], correctIndex: 1, explanation: 'Tanıştığıma memnun oldum', tags: ['greeting'] },
  { id: 'en_gr_k3', subject: 'ingilizce', topic: 'greetings', difficulty: 'kolay', question: 'What do you say when you leave?', options: ['Hello', 'Hi', 'Goodbye', 'Good morning'], correctIndex: 2, explanation: 'Goodbye = Hoşça kal', tags: ['greeting'] },
  { id: 'en_gr_k4', subject: 'ingilizce', topic: 'greetings', difficulty: 'kolay', question: '"How are you?" cevabı hangisidir?', options: ['I am fine, thanks', 'I am go', 'I am from Turkey', 'I am 14'], correctIndex: 0, explanation: 'I am fine, thanks', tags: ['greeting'] },
  { id: 'en_gr_k5', subject: 'ingilizce', topic: 'greetings', difficulty: 'kolay', question: '"What is your name?" cevabı:', options: ['I am fine', 'My name is Ali', 'I am 14', 'I like football'], correctIndex: 1, explanation: 'My name is...', tags: ['greeting'] },
  { id: 'en_gr_o1', subject: 'ingilizce', topic: 'greetings', difficulty: 'orta', question: 'Which is a formal greeting?', options: ['Hey!', 'What\'s up?', 'How do you do?', 'Yo!'], correctIndex: 2, explanation: 'How do you do resmidir', tags: ['formal'] },
  { id: 'en_gr_o2', subject: 'ingilizce', topic: 'greetings', difficulty: 'orta', question: '"See you later" means:', options: ['Hoşça kal', 'Sonra görüşürüz', 'Merhaba', 'Tanıştığıma memnun oldum'], correctIndex: 1, explanation: 'See you later = Sonra görüşürüz', tags: ['farewell'] },
  { id: 'en_gr_o3', subject: 'ingilizce', topic: 'greetings', difficulty: 'orta', question: 'When do you say "Good evening"?', options: ['Morning', 'Afternoon', 'Evening', 'Night'], correctIndex: 2, explanation: 'Akşam vakti', tags: ['time'] },
  { id: 'en_gr_o4', subject: 'ingilizce', topic: 'greetings', difficulty: 'orta', question: '"Pleased to meet you" is similar to:', options: ['Goodbye', 'Nice to meet you', 'See you', 'How are you'], correctIndex: 1, explanation: 'Aynı anlam', tags: ['synonym'] },
  { id: 'en_gr_o5', subject: 'ingilizce', topic: 'greetings', difficulty: 'orta', question: 'A: "How is it going?" B: "___"', options: ['I am Turkey', 'Pretty good, thanks', 'My name is B', 'See you'], correctIndex: 1, explanation: 'Durumumu soruyor', tags: ['informal'] },
  { id: 'en_gr_z1', subject: 'ingilizce', topic: 'greetings', difficulty: 'zor', question: '"Long time no see" means:', options: ['Uzun zaman geçti görmeyeli', 'Uzun süre bak', 'Uzun yol', 'Çok bekledim'], correctIndex: 0, explanation: 'Uzun zamandır görüşemedik', tags: ['idiom'] },
  { id: 'en_gr_z2', subject: 'ingilizce', topic: 'greetings', difficulty: 'zor', question: 'Which is NOT a way to say goodbye?', options: ['Take care', 'Catch you later', 'How do you do', 'See you around'], correctIndex: 2, explanation: 'How do you do = karşılaşma', tags: ['farewell'] },
  { id: 'en_gr_z3', subject: 'ingilizce', topic: 'greetings', difficulty: 'zor', question: '"Regards" is used in:', options: ['Phone calls', 'E-mails/letters', 'Face to face', 'Text messages only'], correctIndex: 1, explanation: 'Formal yazışmalarda', tags: ['formal'] },

  // İNGİLİZCE: Present Tense ek
  { id: 'en_pt_k1', subject: 'ingilizce', topic: 'present_tense', difficulty: 'kolay', question: 'She ___ to school every day.', options: ['go', 'goes', 'going', 'gone'], correctIndex: 1, explanation: '3. tekil → -s/-es', tags: ['simple present'] },
  { id: 'en_pt_k2', subject: 'ingilizce', topic: 'present_tense', difficulty: 'kolay', question: 'They ___ football on Sundays.', options: ['plays', 'play', 'playing', 'played'], correctIndex: 1, explanation: 'Çoğul özne → ek yok', tags: ['simple present'] },
  { id: 'en_pt_k3', subject: 'ingilizce', topic: 'present_tense', difficulty: 'kolay', question: 'I ___ English.', options: ['speaks', 'speaking', 'speak', 'spoke'], correctIndex: 2, explanation: 'I + V1', tags: ['simple present'] },
  { id: 'en_pt_k4', subject: 'ingilizce', topic: 'present_tense', difficulty: 'kolay', question: 'He ___ breakfast at 8.', options: ['have', 'has', 'having', 'had'], correctIndex: 1, explanation: 'He/She/It → has', tags: ['simple present'] },
  { id: 'en_pt_k5', subject: 'ingilizce', topic: 'present_tense', difficulty: 'kolay', question: 'We ___ like homework.', options: ['doesn\'t', 'don\'t', 'isn\'t', 'aren\'t'], correctIndex: 1, explanation: 'We + don\'t', tags: ['negative'] },
  { id: 'en_pt_o1', subject: 'ingilizce', topic: 'present_tense', difficulty: 'orta', question: '___ she like music?', options: ['Do', 'Does', 'Is', 'Are'], correctIndex: 1, explanation: 'She → Does', tags: ['question'] },
  { id: 'en_pt_o2', subject: 'ingilizce', topic: 'present_tense', difficulty: 'orta', question: 'She ___ TV right now. (present continuous)', options: ['watch', 'watches', 'is watching', 'watched'], correctIndex: 2, explanation: 'Şu an → present continuous', tags: ['continuous'] },
  { id: 'en_pt_o3', subject: 'ingilizce', topic: 'present_tense', difficulty: 'orta', question: 'Water ___ at 100°C.', options: ['boil', 'boils', 'boiling', 'boiled'], correctIndex: 1, explanation: 'Bilimsel gerçek → simple present', tags: ['fact'] },
  { id: 'en_pt_o4', subject: 'ingilizce', topic: 'present_tense', difficulty: 'orta', question: 'Look! The baby ___.', options: ['cry', 'cries', 'is crying', 'cried'], correctIndex: 2, explanation: 'Look! → şu an oluyor', tags: ['continuous'] },
  { id: 'en_pt_o5', subject: 'ingilizce', topic: 'present_tense', difficulty: 'orta', question: 'I ___ to the cinema every Friday.', options: ['am going', 'go', 'goes', 'went'], correctIndex: 1, explanation: 'Every Friday → alışkanlık → simple', tags: ['habit'] },
  { id: 'en_pt_z1', subject: 'ingilizce', topic: 'present_tense', difficulty: 'zor', question: 'She ___ (not/understand) this question.', options: ['isn\'t understanding', 'doesn\'t understand', 'don\'t understand', 'not understands'], correctIndex: 1, explanation: 'Understand = durum fiili → simple', tags: ['stative verb'] },
  { id: 'en_pt_z2', subject: 'ingilizce', topic: 'present_tense', difficulty: 'zor', question: 'I ___ you are right. (think = düşünmek/inanmak)', options: ['am thinking', 'think', 'thinks', 'thought'], correctIndex: 1, explanation: 'Think (inanç) → simple present', tags: ['stative'] },
  { id: 'en_pt_z3', subject: 'ingilizce', topic: 'present_tense', difficulty: 'zor', question: 'The train ___ at 9:30 tomorrow. (schedule)', options: ['leaves', 'is leaving', 'will leave', 'left'], correctIndex: 0, explanation: 'Çizelge → simple present', tags: ['timetable'] },

  // İNGİLİZCE: Past Tense ek
  { id: 'en_ps_k1', subject: 'ingilizce', topic: 'past_tense', difficulty: 'kolay', question: 'I ___ to school yesterday.', options: ['go', 'goes', 'went', 'going'], correctIndex: 2, explanation: 'Go → went', tags: ['irregular'] },
  { id: 'en_ps_k2', subject: 'ingilizce', topic: 'past_tense', difficulty: 'kolay', question: 'She ___ her homework last night.', options: ['do', 'does', 'did', 'doing'], correctIndex: 2, explanation: 'Do → did', tags: ['irregular'] },
  { id: 'en_ps_k3', subject: 'ingilizce', topic: 'past_tense', difficulty: 'kolay', question: 'We ___ a movie last week.', options: ['watch', 'watched', 'watching', 'watches'], correctIndex: 1, explanation: '-ed eklenir', tags: ['regular'] },
  { id: 'en_ps_k4', subject: 'ingilizce', topic: 'past_tense', difficulty: 'kolay', question: 'They ___ happy yesterday.', options: ['are', 'is', 'were', 'was'], correctIndex: 2, explanation: 'They → were', tags: ['was/were'] },
  { id: 'en_ps_k5', subject: 'ingilizce', topic: 'past_tense', difficulty: 'kolay', question: 'He ___ a book last month.', options: ['read', 'reads', 'reading', 'readed'], correctIndex: 0, explanation: 'Read (geçmiş de read)', tags: ['irregular'] },
  { id: 'en_ps_o1', subject: 'ingilizce', topic: 'past_tense', difficulty: 'orta', question: '___ you go to the party?', options: ['Do', 'Did', 'Does', 'Was'], correctIndex: 1, explanation: 'Geçmiş soru → Did', tags: ['question'] },
  { id: 'en_ps_o2', subject: 'ingilizce', topic: 'past_tense', difficulty: 'orta', question: 'She ___ (not/come) to class.', options: ['didn\'t come', 'doesn\'t come', 'wasn\'t come', 'not came'], correctIndex: 0, explanation: 'Didn\'t + V1', tags: ['negative'] },
  { id: 'en_ps_o3', subject: 'ingilizce', topic: 'past_tense', difficulty: 'orta', question: 'While I ___ (study), the phone rang.', options: ['studied', 'was studying', 'am studying', 'study'], correctIndex: 1, explanation: 'While → past continuous', tags: ['continuous'] },
  { id: 'en_ps_o4', subject: 'ingilizce', topic: 'past_tense', difficulty: 'orta', question: '"Eat" past tense hali nedir?', options: ['Eated', 'Ate', 'Eaten', 'Eating'], correctIndex: 1, explanation: 'Eat → ate → eaten', tags: ['irregular'] },
  { id: 'en_ps_o5', subject: 'ingilizce', topic: 'past_tense', difficulty: 'orta', question: 'I ___ born in 2012.', options: ['am', 'is', 'was', 'were'], correctIndex: 2, explanation: 'I → was', tags: ['was/were'] },
  { id: 'en_ps_z1', subject: 'ingilizce', topic: 'past_tense', difficulty: 'zor', question: 'By the time I arrived, they ___ (leave).', options: ['left', 'had left', 'were leaving', 'have left'], correctIndex: 1, explanation: 'Past perfect → had left', tags: ['past perfect'] },
  { id: 'en_ps_z2', subject: 'ingilizce', topic: 'past_tense', difficulty: 'zor', question: '"I used to play" ne anlama gelir?', options: ['Eskiden oynardım', 'Oynuyorum', 'Oynayacağım', 'Oynamalıyım'], correctIndex: 0, explanation: 'Used to = geçmişteki alışkanlık', tags: ['used to'] },
  { id: 'en_ps_z3', subject: 'ingilizce', topic: 'past_tense', difficulty: 'zor', question: 'She ___ (work) when the accident happened.', options: ['worked', 'was working', 'had worked', 'works'], correctIndex: 1, explanation: 'Devam ederken oldu → past continuous', tags: ['continuous'] },

  // İNGİLİZCE: Vocabulary ek
  { id: 'en_vc_k1', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'kolay', question: '"Apple" ne demek?', options: ['Portakal', 'Elma', 'Armut', 'Muz'], correctIndex: 1, explanation: 'Elma', tags: ['fruit'] },
  { id: 'en_vc_k2', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'kolay', question: '"Teacher" ne demek?', options: ['Doktor', 'Öğretmen', 'Mühendis', 'Avukat'], correctIndex: 1, explanation: 'Öğretmen', tags: ['job'] },
  { id: 'en_vc_k3', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'kolay', question: '"Hospital" ne demek?', options: ['Okul', 'Ev', 'Hastane', 'Market'], correctIndex: 2, explanation: 'Hastane', tags: ['place'] },
  { id: 'en_vc_k4', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'kolay', question: '"Brother" ne demek?', options: ['Kız kardeş', 'Anne', 'Baba', 'Erkek kardeş'], correctIndex: 3, explanation: 'Erkek kardeş', tags: ['family'] },
  { id: 'en_vc_k5', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'kolay', question: '"Blue" hangi renk?', options: ['Kırmızı', 'Yeşil', 'Mavi', 'Sarı'], correctIndex: 2, explanation: 'Mavi', tags: ['color'] },
  { id: 'en_vc_o1', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'orta', question: '"Brave" ne demek?', options: ['Korkak', 'Cesur', 'Tembel', 'Çalışkan'], correctIndex: 1, explanation: 'Cesur', tags: ['adjective'] },
  { id: 'en_vc_o2', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'orta', question: '"Suddenly" ne demek?', options: ['Yavaşça', 'Birden', 'Her zaman', 'Nadiren'], correctIndex: 1, explanation: 'Birden, aniden', tags: ['adverb'] },
  { id: 'en_vc_o3', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'orta', question: '"Environment" ne demek?', options: ['Teknoloji', 'Çevre', 'Ekonomi', 'Eğitim'], correctIndex: 1, explanation: 'Çevre', tags: ['nature'] },
  { id: 'en_vc_o4', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'orta', question: '"Achievement" ne demek?', options: ['Başarı', 'Başarısızlık', 'Deneyim', 'Sorun'], correctIndex: 0, explanation: 'Başarı', tags: ['noun'] },
  { id: 'en_vc_o5', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'orta', question: '"Generous" ne demek?', options: ['Cimri', 'Cömert', 'Kibirli', 'Sessiz'], correctIndex: 1, explanation: 'Cömert', tags: ['adjective'] },
  { id: 'en_vc_z1', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'zor', question: '"Reluctant" ne demek?', options: ['İsteksiz', 'Heyecanlı', 'Sabırlı', 'Kararlı'], correctIndex: 0, explanation: 'İsteksiz, gönülsüz', tags: ['adjective'] },
  { id: 'en_vc_z2', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'zor', question: '"Consequence" ne demek?', options: ['Sebep', 'Sonuç', 'Sorun', 'Çözüm'], correctIndex: 1, explanation: 'Sonuç', tags: ['noun'] },
  { id: 'en_vc_z3', subject: 'ingilizce', topic: 'vocabulary', difficulty: 'zor', question: '"Despite" ne demek?', options: ['Sayesinde', 'Rağmen', 'İçin', 'Boyunca'], correctIndex: 1, explanation: '-e rağmen', tags: ['preposition'] },

  // MATEMATİK: Toplama-Çıkarma ek
  { id: 'mt_tc_k1', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'kolay', question: '(-5) + (+8) = ?', options: ['3', '-3', '13', '-13'], correctIndex: 0, explanation: '-5+8=3', tags: ['tam sayı'] },
  { id: 'mt_tc_k2', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'kolay', question: '(-12) + (-7) = ?', options: ['-19', '19', '-5', '5'], correctIndex: 0, explanation: 'Negatif + negatif', tags: ['toplama'] },
  { id: 'mt_tc_k3', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'kolay', question: '25 - (-3) = ?', options: ['22', '28', '25', '-28'], correctIndex: 1, explanation: '25-(-3)=25+3=28', tags: ['çıkarma'] },
  { id: 'mt_tc_k4', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'kolay', question: '0 + (-15) = ?', options: ['-15', '15', '0', '-30'], correctIndex: 0, explanation: '0 etkisiz', tags: ['etkisiz'] },
  { id: 'mt_tc_k5', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'kolay', question: '(-9) - (-9) = ?', options: ['-18', '18', '0', '9'], correctIndex: 2, explanation: '-9+9=0', tags: ['ters eleman'] },
  { id: 'mt_tc_o1', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'orta', question: '(-3) + (+7) + (-5) + (+2) = ?', options: ['1', '-1', '3', '-3'], correctIndex: 0, explanation: '(-3-5)+(7+2)=-8+9=1', tags: ['çoklu'] },
  { id: 'mt_tc_o2', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'orta', question: 'Bir asansör 3. kattan 5 kat aşağı iner. Kaçıncı kattadır?', options: ['-2', '2', '-1', '8'], correctIndex: 0, explanation: '3-5=-2 (bodrum)', tags: ['problem'] },
  { id: 'mt_tc_o3', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'orta', question: '|(-7) + 3| = ?', options: ['4', '-4', '10', '-10'], correctIndex: 0, explanation: '|-4|=4', tags: ['mutlak değer'] },
  { id: 'mt_tc_o4', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'orta', question: 'Bir sayının -5 ile toplamı 12 ise sayı kaçtır?', options: ['17', '7', '-17', '-7'], correctIndex: 0, explanation: 'x+(-5)=12 → x=17', tags: ['bilinmeyen'] },
  { id: 'mt_tc_o5', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'orta', question: '-100 + 75 - (-25) = ?', options: ['0', '-50', '50', '-100'], correctIndex: 0, explanation: '-100+75+25=0', tags: ['karma'] },
  { id: 'mt_tc_z1', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'zor', question: 'Ardışık 3 negatif tam sayının toplamı -24. En küçüğü kaçtır?', options: ['-9', '-7', '-8', '-10'], correctIndex: 0, explanation: 'x+(x+1)+(x+2)=-24 → 3x+3=-24 → x=-9', tags: ['ardışık'] },
  { id: 'mt_tc_z2', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'zor', question: '(-1)+(-2)+(-3)+...+(-10) = ?', options: ['-55', '-45', '-50', '-40'], correctIndex: 0, explanation: '-(1+2+...+10)=-55', tags: ['seri'] },
  { id: 'mt_tc_z3', subject: 'matematik', topic: 'toplama_cikarma', difficulty: 'zor', question: 'Sıcaklık -8°C iken 15°C artarsa kaç °C olur?', options: ['7', '-23', '23', '-7'], correctIndex: 0, explanation: '-8+15=7', tags: ['sıcaklık'] },

  // MATEMATİK: Çarpma-Bölme ek
  { id: 'mt_cb_k1', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'kolay', question: '(-4) × (+3) = ?', options: ['-12', '12', '-7', '7'], correctIndex: 0, explanation: 'Negatif × Pozitif = Negatif', tags: ['çarpma'] },
  { id: 'mt_cb_k2', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'kolay', question: '(-6) × (-5) = ?', options: ['-30', '30', '-11', '11'], correctIndex: 1, explanation: 'Negatif × Negatif = Pozitif', tags: ['çarpma'] },
  { id: 'mt_cb_k3', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'kolay', question: '(-24) ÷ (+6) = ?', options: ['4', '-4', '18', '-18'], correctIndex: 1, explanation: 'Negatif ÷ Pozitif = Negatif', tags: ['bölme'] },
  { id: 'mt_cb_k4', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'kolay', question: '0 × (-99) = ?', options: ['0', '-99', '99', '-1'], correctIndex: 0, explanation: '0 ile çarpma = 0', tags: ['sıfır'] },
  { id: 'mt_cb_k5', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'kolay', question: '(-7) × (+1) = ?', options: ['-7', '7', '-1', '1'], correctIndex: 0, explanation: '1 ile çarpma değiştirmez', tags: ['etkisiz'] },
  { id: 'mt_cb_o1', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'orta', question: '(-2)³ = ?', options: ['-8', '8', '-6', '6'], correctIndex: 0, explanation: '(-2)×(-2)×(-2)=-8', tags: ['üs'] },
  { id: 'mt_cb_o2', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'orta', question: '(-36) ÷ (-4) ÷ (+3) = ?', options: ['3', '-3', '9', '-9'], correctIndex: 0, explanation: '9÷3=3', tags: ['zincirleme'] },
  { id: 'mt_cb_o3', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'orta', question: 'Bir sayı (-5) ile çarpılıp (-3) ile bölününce 10 çıkıyor. Sayı kaçtır?', options: ['-6', '6', '-2', '2'], correctIndex: 0, explanation: 'x×(-5)/(-3)=10 → 5x/3=10 → x=-6', tags: ['problem'] },
  { id: 'mt_cb_o4', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'orta', question: '(-8) × (-8) = ?', options: ['64', '-64', '16', '-16'], correctIndex: 0, explanation: 'Negatif × Negatif = Pozitif', tags: ['çarpma'] },
  { id: 'mt_cb_o5', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'orta', question: '(-1)¹⁰⁰ = ?', options: ['1', '-1', '100', '-100'], correctIndex: 0, explanation: 'Çift üs = pozitif', tags: ['üs'] },
  { id: 'mt_cb_z1', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'zor', question: '(-2)×(-3)×(-4) = ?', options: ['-24', '24', '-12', '12'], correctIndex: 0, explanation: 'Tek sayıda negatif = negatif', tags: ['çoklu çarpma'] },
  { id: 'mt_cb_z2', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'zor', question: 'a×b>0 ve a+b<0 ise a ve b nasıl sayılardır?', options: ['İkisi de negatif', 'İkisi de pozitif', 'Biri negatif biri pozitif', 'Biri sıfır'], correctIndex: 0, explanation: 'Çarpım pozitif + toplam negatif → ikisi de negatif', tags: ['mantık'] },
  { id: 'mt_cb_z3', subject: 'matematik', topic: 'carpma_bolme', difficulty: 'zor', question: '(-1)²⁰²⁵ + (-1)²⁰²⁶ = ?', options: ['0', '-2', '2', '-1'], correctIndex: 0, explanation: '-1+1=0', tags: ['üs'] },

  // MATEMATİK: Kesirler ek
  { id: 'mt_ks_k1', subject: 'matematik', topic: 'kesirler', difficulty: 'kolay', question: '1/2 + 1/4 = ?', options: ['3/4', '2/6', '1/6', '2/4'], correctIndex: 0, explanation: '2/4+1/4=3/4', tags: ['toplama'] },
  { id: 'mt_ks_k2', subject: 'matematik', topic: 'kesirler', difficulty: 'kolay', question: '3/5 hangisine eşittir?', options: ['6/10', '3/10', '9/10', '1/5'], correctIndex: 0, explanation: '3/5=6/10', tags: ['denk kesir'] },
  { id: 'mt_ks_k3', subject: 'matematik', topic: 'kesirler', difficulty: 'kolay', question: '2/3 - 1/3 = ?', options: ['1/3', '1/6', '3/3', '2/6'], correctIndex: 0, explanation: '1/3', tags: ['çıkarma'] },
  { id: 'mt_ks_k4', subject: 'matematik', topic: 'kesirler', difficulty: 'kolay', question: 'Bir bileşik kesir nedir?', options: ['Pay > Payda', 'Pay < Payda', 'Pay = Payda', 'Pay = 0'], correctIndex: 0, explanation: 'Pay paydadan büyük', tags: ['tanım'] },
  { id: 'mt_ks_k5', subject: 'matematik', topic: 'kesirler', difficulty: 'kolay', question: '7/7 = ?', options: ['0', '1', '7', '49'], correctIndex: 1, explanation: 'Pay=Payda → 1', tags: ['eşitlik'] },
  { id: 'mt_ks_o1', subject: 'matematik', topic: 'kesirler', difficulty: 'orta', question: '2/3 × 3/4 = ?', options: ['1/2', '6/12', '5/7', '6/7'], correctIndex: 0, explanation: '6/12=1/2', tags: ['çarpma'] },
  { id: 'mt_ks_o2', subject: 'matematik', topic: 'kesirler', difficulty: 'orta', question: '3/4 ÷ 1/2 = ?', options: ['3/8', '3/2', '6/4', '1/2'], correctIndex: 1, explanation: '3/4 × 2/1 = 6/4 = 3/2', tags: ['bölme'] },
  { id: 'mt_ks_o3', subject: 'matematik', topic: 'kesirler', difficulty: 'orta', question: '2 1/3 bileşik kesrini düzgün kesire çevir.', options: ['7/3', '5/3', '8/3', '6/3'], correctIndex: 0, explanation: '2×3+1=7 → 7/3', tags: ['çevirme'] },
  { id: 'mt_ks_o4', subject: 'matematik', topic: 'kesirler', difficulty: 'orta', question: 'Bir pizzanın 3/8\'ini yedim. Kalan ne kadar?', options: ['5/8', '3/8', '1/2', '1/4'], correctIndex: 0, explanation: '8/8-3/8=5/8', tags: ['problem'] },
  { id: 'mt_ks_o5', subject: 'matematik', topic: 'kesirler', difficulty: 'orta', question: '5/6 ve 7/9 hangisi büyüktür?', options: ['5/6', '7/9', 'Eşit', 'Karşılaştırılamaz'], correctIndex: 0, explanation: '15/18 > 14/18', tags: ['karşılaştırma'] },
  { id: 'mt_ks_z1', subject: 'matematik', topic: 'kesirler', difficulty: 'zor', question: '(2/3 + 1/6) × 12 = ?', options: ['10', '8', '12', '6'], correctIndex: 0, explanation: '(4/6+1/6)×12 = 5/6×12 = 10', tags: ['karma'] },
  { id: 'mt_ks_z2', subject: 'matematik', topic: 'kesirler', difficulty: 'zor', question: 'Bir sayının 3/4\'ü 45 ise sayı kaçtır?', options: ['60', '45', '30', '90'], correctIndex: 0, explanation: '45÷3×4=60', tags: ['kesir problemi'] },
  { id: 'mt_ks_z3', subject: 'matematik', topic: 'kesirler', difficulty: 'zor', question: '1/(1/2 + 1/3) = ?', options: ['6/5', '5/6', '1/5', '5'], correctIndex: 0, explanation: '1/(5/6)=6/5', tags: ['bileşik'] },

  // MATEMATİK: Geometri ek
  { id: 'mt_ge_k1', subject: 'matematik', topic: 'geometri', difficulty: 'kolay', question: 'Bir karenin tüm kenarları eşit midir?', options: ['Evet', 'Hayır', 'Bazen', 'Sadece ikisi'], correctIndex: 0, explanation: 'Kare 4 eşit kenarlı', tags: ['kare'] },
  { id: 'mt_ge_k2', subject: 'matematik', topic: 'geometri', difficulty: 'kolay', question: 'Dikdörtgenin alanı nasıl hesaplanır?', options: ['Uzun kenar × Kısa kenar', 'Kenar × 4', 'Kenar²', 'Çevre ÷ 2'], correctIndex: 0, explanation: 'a × b', tags: ['alan'] },
  { id: 'mt_ge_k3', subject: 'matematik', topic: 'geometri', difficulty: 'kolay', question: 'Bir üçgenin iç açıları toplamı kaç derecedir?', options: ['180', '360', '90', '270'], correctIndex: 0, explanation: '180°', tags: ['açı'] },
  { id: 'mt_ge_k4', subject: 'matematik', topic: 'geometri', difficulty: 'kolay', question: 'Dairenin çevresi nasıl hesaplanır?', options: ['2πr', 'πr²', 'πd²', '4r'], correctIndex: 0, explanation: '2πr veya πd', tags: ['daire'] },
  { id: 'mt_ge_k5', subject: 'matematik', topic: 'geometri', difficulty: 'kolay', question: 'Kenarları 5 cm olan karenin çevresi kaç cm?', options: ['20', '25', '10', '15'], correctIndex: 0, explanation: '4×5=20', tags: ['çevre'] },
  { id: 'mt_ge_o1', subject: 'matematik', topic: 'geometri', difficulty: 'orta', question: 'Kenarları 3, 4, 5 cm olan üçgenin çevresi?', options: ['12', '10', '15', '20'], correctIndex: 0, explanation: '3+4+5=12', tags: ['çevre'] },
  { id: 'mt_ge_o2', subject: 'matematik', topic: 'geometri', difficulty: 'orta', question: 'Yarıçapı 7 cm olan dairenin alanı? (π≈22/7)', options: ['154 cm²', '44 cm²', '77 cm²', '308 cm²'], correctIndex: 0, explanation: 'πr²=22/7×49=154', tags: ['alan'] },
  { id: 'mt_ge_o3', subject: 'matematik', topic: 'geometri', difficulty: 'orta', question: 'Bir dikdörtgenin köşegenleri birbirini ortalar mı?', options: ['Evet', 'Hayır', 'Bazen', 'Sadece karede'], correctIndex: 0, explanation: 'Dikdörtgende köşegenler ortadan keser', tags: ['köşegen'] },
  { id: 'mt_ge_o4', subject: 'matematik', topic: 'geometri', difficulty: 'orta', question: 'Paralelkenarın alanı nasıl hesaplanır?', options: ['Taban × Yükseklik', 'Kenar × Kenar', 'Çevre / 2', 'Köşegen²'], correctIndex: 0, explanation: 'A = a × h', tags: ['alan'] },
  { id: 'mt_ge_o5', subject: 'matematik', topic: 'geometri', difficulty: 'orta', question: 'Eşkenar üçgenin her açısı kaç derecedir?', options: ['60', '90', '45', '120'], correctIndex: 0, explanation: '180/3=60', tags: ['açı'] },
  { id: 'mt_ge_z1', subject: 'matematik', topic: 'geometri', difficulty: 'zor', question: 'Bir yamukta paralel kenarlar 8 ve 12 cm, yükseklik 5 cm ise alan?', options: ['50 cm²', '40 cm²', '60 cm²', '100 cm²'], correctIndex: 0, explanation: '(8+12)×5/2=50', tags: ['yamuk'] },
  { id: 'mt_ge_z2', subject: 'matematik', topic: 'geometri', difficulty: 'zor', question: 'Bir dairenin yarıçapı iki katına çıkarsa alanı kaç kat artar?', options: ['2', '3', '4', '8'], correctIndex: 2, explanation: 'π(2r)²=4πr²', tags: ['alan değişimi'] },
  { id: 'mt_ge_z3', subject: 'matematik', topic: 'geometri', difficulty: 'zor', question: 'Bir dikdörtgenin alanı 48 cm², eni 6 cm ise köşegen uzunluğu?', options: ['10', '8', '12', '14'], correctIndex: 0, explanation: 'Boy=8. √(6²+8²)=√100=10', tags: ['pisagor'] },

  // MATEMATİK: Oran-Orantı ek
  { id: 'mt_oo_k1', subject: 'matematik', topic: 'oran_oranti', difficulty: 'kolay', question: '3/5 oranının eşiti hangisidir?', options: ['6/10', '3/10', '9/5', '5/3'], correctIndex: 0, explanation: '3/5=6/10', tags: ['eşit oran'] },
  { id: 'mt_oo_k2', subject: 'matematik', topic: 'oran_oranti', difficulty: 'kolay', question: 'Bir sınıfta 12 kız 18 erkek var. Kız/erkek oranı?', options: ['2/3', '3/2', '12/18', '1/2'], correctIndex: 0, explanation: '12/18=2/3', tags: ['oran'] },
  { id: 'mt_oo_k3', subject: 'matematik', topic: 'oran_oranti', difficulty: 'kolay', question: '4:8 oranı sadeleştirilirse?', options: ['1:2', '2:4', '4:8', '1:4'], correctIndex: 0, explanation: '4/4:8/4=1:2', tags: ['sadeleştirme'] },
  { id: 'mt_oo_k4', subject: 'matematik', topic: 'oran_oranti', difficulty: 'kolay', question: '2/x = 6/15 ise x = ?', options: ['5', '3', '10', '7'], correctIndex: 0, explanation: '2×15=6×x → x=5', tags: ['orantı'] },
  { id: 'mt_oo_k5', subject: 'matematik', topic: 'oran_oranti', difficulty: 'kolay', question: 'Doğru orantıda biri artarsa diğeri ne olur?', options: ['Artar', 'Azalır', 'Sabit kalır', 'Sıfırlanır'], correctIndex: 0, explanation: 'Doğru orantı → birlikte artış', tags: ['doğru orantı'] },
  { id: 'mt_oo_o1', subject: 'matematik', topic: 'oran_oranti', difficulty: 'orta', question: '3 işçi bir işi 12 günde bitirir. 6 işçi kaç günde bitirir?', options: ['6', '24', '4', '8'], correctIndex: 0, explanation: 'Ters orantı: 3×12=6×x → x=6', tags: ['ters orantı'] },
  { id: 'mt_oo_o2', subject: 'matematik', topic: 'oran_oranti', difficulty: 'orta', question: 'A ve B toplamı 60. A:B = 2:3 ise A kaçtır?', options: ['24', '36', '20', '40'], correctIndex: 0, explanation: '60×2/5=24', tags: ['orantılı bölüşme'] },
  { id: 'mt_oo_o3', subject: 'matematik', topic: 'oran_oranti', difficulty: 'orta', question: '5 litrelik benzin 100 km gidiyorsa 300 km için kaç litre?', options: ['15', '10', '20', '25'], correctIndex: 0, explanation: '5×3=15', tags: ['doğru orantı'] },
  { id: 'mt_oo_o4', subject: 'matematik', topic: 'oran_oranti', difficulty: 'orta', question: 'x/3 = 8/6 ise x = ?', options: ['4', '6', '8', '2'], correctIndex: 0, explanation: '6x=24 → x=4', tags: ['orantı'] },
  { id: 'mt_oo_o5', subject: 'matematik', topic: 'oran_oranti', difficulty: 'orta', question: 'Haritada 1 cm = 50 km. 3.5 cm kaç km?', options: ['175', '150', '200', '100'], correctIndex: 0, explanation: '3.5×50=175', tags: ['ölçek'] },
  { id: 'mt_oo_z1', subject: 'matematik', topic: 'oran_oranti', difficulty: 'zor', question: 'A:B = 2:3, B:C = 4:5 ise A:B:C = ?', options: ['8:12:15', '2:3:5', '4:6:5', '2:4:5'], correctIndex: 0, explanation: 'B ortak: 2:3 → 8:12, 4:5 → 12:15', tags: ['bileşik oran'] },
  { id: 'mt_oo_z2', subject: 'matematik', topic: 'oran_oranti', difficulty: 'zor', question: 'Bir havuz 3 muslukla 4 saatte dolar. 6 muslukla kaç saatte dolar?', options: ['2', '8', '1', '3'], correctIndex: 0, explanation: 'Ters orantı: 3×4=6×x → x=2', tags: ['ters orantı'] },
  { id: 'mt_oo_z3', subject: 'matematik', topic: 'oran_oranti', difficulty: 'zor', question: '120 TL 3 kişiye 2:3:5 oranında paylaştırılıyor. En çok alan kaç TL alır?', options: ['60', '36', '24', '48'], correctIndex: 0, explanation: '120×5/10=60', tags: ['paylaşım'] },

  // MATEMATİK: Denklemler ek
  { id: 'mt_dk_k1', subject: 'matematik', topic: 'denklemler', difficulty: 'kolay', question: 'x + 5 = 12 ise x = ?', options: ['7', '17', '5', '12'], correctIndex: 0, explanation: 'x=12-5=7', tags: ['1. derece'] },
  { id: 'mt_dk_k2', subject: 'matematik', topic: 'denklemler', difficulty: 'kolay', question: '3x = 21 ise x = ?', options: ['7', '18', '63', '24'], correctIndex: 0, explanation: 'x=21/3=7', tags: ['1. derece'] },
  { id: 'mt_dk_k3', subject: 'matematik', topic: 'denklemler', difficulty: 'kolay', question: 'x - 4 = 10 ise x = ?', options: ['14', '6', '40', '-14'], correctIndex: 0, explanation: 'x=14', tags: ['1. derece'] },
  { id: 'mt_dk_k4', subject: 'matematik', topic: 'denklemler', difficulty: 'kolay', question: '2x + 3 = 11 ise x = ?', options: ['4', '7', '5', '3'], correctIndex: 0, explanation: '2x=8 → x=4', tags: ['1. derece'] },
  { id: 'mt_dk_k5', subject: 'matematik', topic: 'denklemler', difficulty: 'kolay', question: 'x/4 = 5 ise x = ?', options: ['20', '1', '9', '25'], correctIndex: 0, explanation: 'x=20', tags: ['1. derece'] },
  { id: 'mt_dk_o1', subject: 'matematik', topic: 'denklemler', difficulty: 'orta', question: '5x - 3 = 2x + 9 ise x = ?', options: ['4', '3', '6', '2'], correctIndex: 0, explanation: '3x=12 → x=4', tags: ['denklem'] },
  { id: 'mt_dk_o2', subject: 'matematik', topic: 'denklemler', difficulty: 'orta', question: 'Bir sayının 3 katının 7 fazlası 25\'tir. Sayı kaçtır?', options: ['6', '8', '4', '10'], correctIndex: 0, explanation: '3x+7=25 → x=6', tags: ['problem'] },
  { id: 'mt_dk_o3', subject: 'matematik', topic: 'denklemler', difficulty: 'orta', question: '2(x+3) = 16 ise x = ?', options: ['5', '8', '6', '4'], correctIndex: 0, explanation: 'x+3=8 → x=5', tags: ['parantez'] },
  { id: 'mt_dk_o4', subject: 'matematik', topic: 'denklemler', difficulty: 'orta', question: 'x + y = 10, x - y = 4 ise x = ?', options: ['7', '3', '8', '5'], correctIndex: 0, explanation: '2x=14 → x=7', tags: ['2 bilinmeyen'] },
  { id: 'mt_dk_o5', subject: 'matematik', topic: 'denklemler', difficulty: 'orta', question: '(x-2)/3 = 4 ise x = ?', options: ['14', '10', '6', '16'], correctIndex: 0, explanation: 'x-2=12 → x=14', tags: ['kesirli'] },
  { id: 'mt_dk_z1', subject: 'matematik', topic: 'denklemler', difficulty: 'zor', question: '3x + 2y = 13, x + y = 5 ise y = ?', options: ['2', '3', '4', '1'], correctIndex: 0, explanation: 'x=5-y → 3(5-y)+2y=13 → 15-y=13 → y=2', tags: ['sistem'] },
  { id: 'mt_dk_z2', subject: 'matematik', topic: 'denklemler', difficulty: 'zor', question: 'Babam benden 25 yaş büyük. 5 yıl sonra yaşlarımız toplamı 55 olacak. Şu an kaç yaşındayım?', options: ['10', '15', '12', '8'], correctIndex: 0, explanation: '(x+5)+(x+30)=55 → 2x+35=55 → x=10', tags: ['yaş problemi'] },
  { id: 'mt_dk_z3', subject: 'matematik', topic: 'denklemler', difficulty: 'zor', question: '|2x - 6| = 10 ise x\'in alabileceği değerlerin toplamı?', options: ['6', '8', '10', '4'], correctIndex: 0, explanation: 'x=8 veya x=-2, toplam=6', tags: ['mutlak değer'] },
];
