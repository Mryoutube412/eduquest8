...
export const SUBJECTS: SubjectInfo[] = [
  {
    ...
    topics: [
      { id: 'es_zit_anlam', name: 'Eş-Zıt Anlam', icon: '🔄', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+t%C3%BCrk%C3%A7e+e%C5%9F+z%C4%B1t+anlam+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'sozcuk_turleri', name: 'Sözcük Türleri', icon: '📝', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+s%C3%B6zc%C3%BCk+t%C3%BCrleri+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'deyimler', name: 'Deyimler', icon: '💬', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+deyimler+konu+anlat%C4%B1m%C4%B1' },
      { id: 'atasozleri', name: 'Atasözleri', icon: '📜', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+atas%C3%B6zleri+konu+anlat%C4%B1m%C4%B1' },
      { id: 'tamlama', name: 'Tamlamalar', icon: '🔗', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+tamlamalar+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'fiiller', name: 'Fiiller', icon: '🏃', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+fiiller+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'ses_bilgisi', name: 'Ses Bilgisi', icon: '🔊', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+ses+bilgisi+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'yazim_kurallari', name: 'Yazım Kuralları', icon: '✍️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+yaz%C4%B1m+kurallar%C4%B1+konu+anlat%C4%B1m%C4%B1' },
      { id: 'fiilimsiler', name: 'Fiilimsiler', icon: '🏃‍♂️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+fiilimsiler+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'cumlenin_ogeleri', name: 'Cümlenin Öğeleri', icon: '🧩', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+c%C3%BCmlenin+%C3%B6%C4%9Feleri+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'cumle_turleri', name: 'Cümle Türleri', icon: '📜', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+c%C3%BCmle+t%C3%BCrleri+konu+anlat%C4%B1m%C4%B1' },
      { id: 'metin_turleri', name: 'Metin Türleri', icon: '📚', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+metin+t%C3%BCrleri+konu+anlat%C4%B1m%C4%B1' },
      { id: 'paragraf', name: 'Paragraf', icon: '📝', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+paragraf+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'noktalama_isaretleri', name: 'Noktalama İşaretleri', icon: '❗', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+noktalama+i%C5%9Faretleri+konu+anlat%C4%B1m%C4%B1' },
      { id: 'gercek_mecaz', name: 'Gerçek-Mecaz Anlam', icon: '🌟', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+ger%C3%A7ek+mecaz+anlam+konu+anlat%C4%B1m%C4%B1' },
      { id: 'oznel_nesnel', name: 'Öznel-Nesnel Anlatım', icon: '🧠', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+%C3%B6znel+nesnel+anlat%C4%B1m+konu+anlat%C4%B1m%C4%B1' },
      { id: 'soz_sanatlari', name: 'Söz Sanatları', icon: '🎨', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+s%C3%B6z+sanatlar%C4%B1+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
    ],
  },
  {
    id: 'matematik',
    ...
    topics: [
      { id: 'toplama_cikarma', name: 'Toplama-Çıkarma', icon: '➕', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+tam+say%C4%B1larla+toplama+%C3%A7%C4%B1karma+konu+anlat%C4%B1m%C4%B1' },
      { id: 'carpma_bolme', name: 'Çarpma-Bölme', icon: '✖️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+%C3%A7arpma+b%C3%B6lme+konu+anlat%C4%B1m%C4%B1' },
      { id: 'kesirler', name: 'Kesirler', icon: '🥧', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+kesirler+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'geometri', name: 'Geometri', icon: '📐', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+geometri+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'uslu_sayilar', name: 'Üslü Sayılar', icon: '🔢', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+%C3%BCsl%C3%BC+say%C4%B1lar+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'denklemler', name: 'Denklemler', icon: '⚖️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+denklemler+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'oran_oranti', name: 'Oran-Orantı', icon: '📊', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+oran+orant%C4%B1+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'olasilik', name: 'Olasılık', icon: '🎲', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+olas%C4%B1l%C4%B1k+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'ebob_ekok', name: 'EBOB-EKOK', icon: '🔍', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+ebob+ekok+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'karekok', name: 'Kareköklü İfadeler', icon: '√', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+karek%C3%B6kl%C3%BC+ifadeler+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'veri_analizi', name: 'Veri Analizi', icon: '📊', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+veri+analizi+konu+anlat%C4%B1m%C4%B1' },
      { id: 'cebirsel_ifadeler', name: 'Cebirsel İfadeler', icon: 'x²', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+cebirsel+ifadeler+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'koordinat', name: 'Koordinat Sistemi', icon: '🗺️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+koordinat+sistemi+konu+anlat%C4%B1m%C4%B1' },
      { id: 'esitsizlik', name: 'Eşitsizlikler', icon: '< >', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+e%C5%9Fitsizlikler+konu+anlat%C4%B1m%C4%B1' },
      { id: 'ucgenler', name: 'Üçgenler & Pisagor', icon: '△', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+%C3%BC%C3%A7genler+pisagor+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'oteleme_yansima', name: 'Öteleme & Yansıma', icon: '↔️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+%C3%B6teleme+yans%C4%B1ma+konu+anlat%C4%B1m%C4%B1' },
      { id: 'prizmalar', name: 'Prizmalar & Geometrik Cisimler', icon: '⬛', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+prizmalar+geometrik+cisimler+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
    ],
  },
  {
    id: 'fen',
    ...
    topics: [
      { id: 'madde', name: 'Madde ve Özellikleri', icon: '🧪', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+madde+ve+%C3%B6zellikleri+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'canlilar', name: 'Canlılar Dünyası', icon: '🌿', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+canl%C4%B1lar+d%C3%BCnyas%C4%B1+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'kuvvet', name: 'Kuvvet ve Hareket', icon: '🏋️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+kuvvet+ve+hareket+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'elektrik', name: 'Elektrik', icon: '⚡', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+elektrik+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'isik_ses', name: 'Işık ve Ses', icon: '💡', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+%C4%B1%C5%9F%C4%B1k+ve+ses+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'dunya_uzay', name: 'Dünya ve Uzay', icon: '🌍', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+d%C3%BCnya+ve+uzay+konu+anlat%C4%B1m%C4%B1' },
      { id: 'ekosistem', name: 'Ekosistem', icon: '🌳', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+ekosistem+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'mevsimler_ve_iklim', name: 'Mevsimler ve İklim', icon: '☀️❄️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+mevsimler+iklim+konu+anlat%C4%B1m%C4%B1' },
      { id: 'dna_genetik_kod', name: 'DNA ve Genetik Kod', icon: '🧬', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+dna+genetik+kod+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'basinc', name: 'Basınç', icon: '📏', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+bas%C4%B1n%C3%A7+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'basit_makineler', name: 'Basit Makineler', icon: '⚙️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+basit+makineler+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
    ],
  },
  {
    id: 'tarih', name: 'T.C. İnkılap Tarihi', icon: '🏛️', gradient: 'gradient-tarih',
    topics: [
      { id: 'kurtulus_savasi', name: 'Kurtuluş Savaşı', icon: '⚔️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+kurtulu%C5%9F+sava%C5%9F%C4%B1+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'cumhuriyet', name: 'Cumhuriyetin İlanı', icon: '🇹🇷', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+cumhuriyetin+ilan%C4%B1+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'ataturk_ilkeleri', name: 'Atatürk İlkeleri', icon: '📋', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+atat%C3%BCrk+ilkeleri+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'inkilaplar', name: 'İnkılaplar', icon: '🔄', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+ink%C4%B1laplar+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'tbmm', name: 'TBMM', icon: '🏛️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+tbmm+a%C3%A7%C4%B1lmas%C4%B1+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'antlasmalar', name: 'Antlaşmalar', icon: '📜', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+antla%C5%9Fmalar+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
      { id: 'milli_mucadele', name: 'Milli Mücadele', icon: '🎖️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+milli+m%C3%BCcadele+konu+anlat%C4%B1m%C4%B1+tongu%C3%A7' },
    ],
  },
  {
    id: 'ingilizce', name: 'İngilizce', icon: '🌍', gradient: 'gradient-ingilizce',
    topics: [
      { id: 'greetings', name: 'Greetings', icon: '👋', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+ingilizce+greetings+konu+anlat%C4%B1m%C4%B1' },
      { id: 'present_tense', name: 'Present Tense', icon: '⏰', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+present+tense+konu+anlat%C4%B1m%C4%B1' },
      { id: 'past_tense', name: 'Past Tense', icon: '⏪', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+past+tense+konu+anlat%C4%B1m%C4%B1' },
      { id: 'vocabulary', name: 'Vocabulary', icon: '📚', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+ingilizce+vocabulary+konu+anlat%C4%B1m%C4%B1' },
      { id: 'prepositions', name: 'Prepositions', icon: '📍', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+prepositions+konu+anlat%C4%B1m%C4%B1' },
      { id: 'comparatives', name: 'Comparatives', icon: '⚖️', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+comparatives+superlatives+konu+anlat%C4%B1m%C4%B1' },
      { id: 'reading', name: 'Reading', icon: '📖', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+ingilizce+reading+konu+anlat%C4%B1m%C4%B1' },
      { id: 'modals', name: 'Modal Verbs', icon: '🔑', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+modal+verbs+konu+anlat%C4%B1m%C4%B1' },
    ],
  },
  {
    id: 'din', name: 'Din Kültürü', icon: '☪️', gradient: 'gradient-din',
    topics: [
      { id: 'ibadet', name: 'İbadet', icon: '🕌', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+din+k%C3%BClt%C3%BCr%C3%BC+ibadet+konu+anlat%C4%B1m%C4%B1' },
      { id: 'kuran', name: "Kur'an-ı Kerim", icon: '📖', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+kuran+kerim+konu+anlat%C4%B1m%C4%B1' },
      { id: 'peygamberler', name: 'Peygamberler', icon: '⭐', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+peygamberler+konu+anlat%C4%B1m%C4%B1' },
      { id: 'ahlak', name: 'Ahlak', icon: '💎', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+din+k%C3%BClt%C3%BCr%C3%BC+ahlak+konu+anlat%C4%B1m%C4%B1' },
      { id: 'islam_tarihi', name: 'İslam Tarihi', icon: '📅', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+islam+tarihi+konu+anlat%C4%B1m%C4%B1' },
      { id: 'inanc', name: 'İnanç', icon: '🤲', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+din+k%C3%BClt%C3%BCr%C3%BC+inan%C3%A7+konu+anlat%C4%B1m%C4%B1' },
      { id: 'hadis', name: 'Hadis', icon: '📜', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+hadis+konu+anlat%C4%B1m%C4%B1' },
      { id: 'degerler', name: 'Değerler Eğitimi', icon: '🌟', videoUrl: 'https://www.youtube.com/results?search_query=8+s%C4%B1n%C4%B1f+de%C4%9Ferler+e%C4%9Fitimi+konu+anlat%C4%B1m%C4%B1' },
    ],
  },
];
